...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitAltcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    //{"xbanode.bitaltcoin.online", "xbanode-a.bitaltcoin.online"},
    //{"xbanode-b.bitaltcoin.online", "xbanode-c.bitaltcoin.online"},
    //{"xbanode-d.bitaltcoin.online", "bitaltcoin.online"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitAltcoin is probably already running."), addrBind.ToString().c_str());
        else
