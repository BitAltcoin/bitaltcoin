...
// Copyright (c) 2015-2016 BitAltcoin Developers
...
uint256 hashGenesisBlock("0x9ab3cbc3b70fa176255b1f80da75c968935129d3b18c7a8952b10a9663a2e1d3");
...
const string strMessageMagic = "BitAltcoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bitaltcoin miner
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex)
{
    ...
    int64 nBIP30SwitchTime = 1457692815;
    bool fEnforceBIP30 = (pindex->nTime > nBIP30SwitchTime);

    // BIP16 didn't become active until October 1 2012
    int64 nBIP16SwitchTime = 1457692815;
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BitAltcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbd70f4e247fa9693dbc0568e258d58317e5bfb185e1fcabb4ebcf5652fb1b5c5");
    }
	...
	// vMerkleTree: 2e422a0e4f
        ...
        assert(block.hashMerkleRoot == uint256("0x83de31b5cc3ad849bb57359e1fa5a5b450ebd46c4d59a9ee573c1f6feb0975d5"));
